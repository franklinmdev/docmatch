...
EXPECTED_MATCH_OUTPUT = "\n".join(
    [
        ...
        # price variance falls to the amount; all are found on labels. A
        # quantity of one unit carries no short-ship or over-ship, which
        # leaves one document without either.
